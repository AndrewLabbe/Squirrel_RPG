...
public class FoxScript extends Script<NPC> {
	...
	protected void setup() {
		...
		// changes what fox says when talking to him the first time (flag is not set) vs
		// talking to him afterwards (flag is set)
		if (!isFlagSet("hasTalkedToFox")) {
			// Plays Sound Effect
			se.playSE(1);
			addTextToTextboxQueue("Hey you, squirrel over there!");
			addTextToTextboxQueue(
					"This place seems to be ridden with zombies,\nI don't know how they got there but they don't belong.");
			...
			se.playSE(1);
			addTextToTextboxQueue(
					"Why are you bothering me for? Go defeat these things\nand don't forget what I said.");
	...
	protected void cleanup() {
		...
		// set flag so that if the fox is talked to again after the first time, what he
		// says changes
