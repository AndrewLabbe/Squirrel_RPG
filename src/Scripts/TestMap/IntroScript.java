...
public class IntroScript extends Script {
	...
	protected void setup() {
		...
		if(!isFlagSet("hasLostGirlfriend")) {
			...
			// Girlfriend Spawns
			addTextToTextboxQueue("Girlfriend: Hey, where have you been? I've been worried.");
			addTextToTextboxQueue("You don't understand how she's alive and safe, but you're thankful.");
			// Enemy Text
			...
			addTextToTextboxQueue("Stranger: I want to rule this world, and you can't stop me!");
			// Enemy Goes Away
			...
			addTextToTextboxQueue("Oh! I see chests, maybe those contain the keys to get into the temple.");
			// Before Enemy truly dissapears to the temple, merks Girlfriend
			addTextToTextboxQueue("Before the stranger truly leaves, strikes your girlfriend with a lightning bolt.");
			addTextToTextboxQueue("WHY? WHY WOULD THEY DO THIS...");
			addTextToTextboxQueue("I will have my revenge, and take anything out in my way!");
			addTextToTextboxQueue("FEAR ME, MYSTERIOUS ENEMY. I SHALL FIND YOU.");
